...
<head>
  ...
  <style>
    ...
    /* Toast stack â€” near sticky Save actions (bottom), always viewport-visible */
    .sca-toast-stack {
    ...
    Alpine.data('studentAccessAdmin', function () {
      return {
        ...
        get panelLoadingLabel() {
          if (this.saveAction === 'create') return 'Creating student accountâ€¦';
          if (this.saveAction === 'account') return 'Saving account detailsâ€¦';
          if (this.saveAction === 'permissions') return 'Saving content accessâ€¦';
          if (this.saveAction === 'bulk') return 'Applying access to selected studentsâ€¦';
          if (this.loadingStudent) return 'Loading student dataâ€¦';
          return 'Please waitâ€¦';
        },
        ...
        showToast(title, message, type) {
          ...
          this.stickyFlash = (title ? title + ' â€” ' : '') + (message || '');
  ...
  <div class="sca-layout">
    ...
    <aside class="sca-sidebar rounded-xl shadow-card border p-5">
      ...
      <div class="relative mb-3">
        ...
        <input type="search" class="input-custom w-full pl-9" placeholder="Name or emailâ€¦" x-model="searchQ" @input.debounce.300ms="searchStudents()">
      </div>
    ...
    <section class="sca-panel rounded-xl shadow-card border p-5" x-show="panelMode === 'create'" x-cloak>
      ...
      <div class="sca-section mb-0">
        ...
        <p class="text-xs text-gray-500 mb-3">Choose specific subjects, lessons, preboards, pre-week, or test bank â€” or enable Full LMS for everything.</p>
      ...
      <div class="sca-sticky-actions">
        <button type="button" class="sca-btn sca-btn--primary" @click="createStudent()" :disabled="saveAction !== null">
          ...
          <span x-text="saveAction === 'create' ? 'Creatingâ€¦' : 'Create student'"></span>
        </button>
    ...
    <section class="sca-panel rounded-xl shadow-card border p-5" x-show="panelMode === 'bulk'" x-cloak>
      ...
      <div class="sca-sticky-actions">
        <button type="button" class="sca-btn sca-btn--primary" @click="saveBulkPermissions()" :disabled="saveAction !== null || selectedIds.length === 0">
          ...
          <span x-text="saveAction === 'bulk' ? 'Applyingâ€¦' : ('Apply to ' + selectedIds.length + ' student' + (selectedIds.length === 1 ? '' : 's'))"></span>
        </button>
    ...
    <section class="sca-panel rounded-xl shadow-card border p-5" x-show="panelMode === 'edit' && selectedId" x-cloak>
        ...
        <div>
            ...
            <div class="flex items-start gap-3">
              ...
              <div>
                ...
                <span class="sca-access-pill mt-2">
                  ...
                  <span x-text="(student.access_start || 'â€”') + ' â†’ ' + (student.access_end || 'â€”')"></span>
                </span>
              </div>
            </div>
          ...
          <div class="sca-section">
            ...
            <button type="button" class="sca-btn sca-btn--outline" @click="saveStudent()" :disabled="saveAction !== null">
              ...
              <span x-text="saveAction === 'account' ? 'Savingâ€¦' : 'Save account details'"></span>
            </button>
          </div>
          ...
          <div class="sca-sticky-actions">
            <button type="button" class="sca-btn sca-btn--primary" @click="savePermissions()" :disabled="saveAction !== null">
              ...
              <span x-text="saveAction === 'permissions' ? 'Savingâ€¦' : 'Save content access'"></span>
            </button>
      ...
      <div class="flex flex-col items-center justify-center py-16 text-gray-400" x-show="loadingStudent && !student">
        ...
        <span class="text-sm font-medium">Loading studentâ€¦</span>
      </div>
    </section>

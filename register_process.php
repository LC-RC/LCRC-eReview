...
if (mysqli_num_rows($result) > 0) {
    ...
    if ($isAjax) sendJson(['success' => false, 'error' => 'This email is already registered. Please use a different email or try logging in.']);
    $_SESSION['error'] = 'This email is already registered. Please use a different email or try logging in.';
    header('Location: registration.php');
    exit;
}
mysqli_stmt_close($checkStmt);
